...
/**
 * Web Script to get Notes and attachments from Salesforce from Opportunity objects
 *
 *  *
 ...
 *
 * url /sfdc/extension/getOpportunityNA
 *
 *
 */
public class GetAllOppsNotesAttachments extends DeclarativeWebScript
{
    private final static Log log = LogFactory.getLog(GetAllOppsNotesAttachments.class);
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache)
    {
        ...
        String queryStr = "Select Id,(Select Name, Id, ParentId from Attachments) from Opportunity";
        String queryNote = "Select Id,(Select Title, Id, ParentId, Body from Notes) from Opportunity";
